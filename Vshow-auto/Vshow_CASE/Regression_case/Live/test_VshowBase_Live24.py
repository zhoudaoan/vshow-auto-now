...
@allure.feature("直播间点击在线观众列表按钮--正常展示当前在线观看用户列表")
class Test_VSHOWBASE_Live24:
...
if __name__ == "__main__":
    pytest.main(["-s", "VSHOWBASE_Live24.py"])
